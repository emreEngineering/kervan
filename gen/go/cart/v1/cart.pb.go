...
const file_cart_v1_cart_proto_rawDesc = "" +
	"\n" +
	"\x12cart/v1/cart.proto\x12\acart.v1\"E\n" +
	"\bCartItem\x12\x1d\n" +
	"\n" +
	...
	"\x05items\x18\x01 \x03(\v2\x11.cart.v1.CartItemR\x05items\"d\n" +
...
var file_cart_v1_cart_proto_goTypes = []any{
	...
	(*ClearCartResponse)(nil),  // 8: cart.v1.ClearCartResponse
}
var file_cart_v1_cart_proto_depIdxs = []int32{
	0, // 0: cart.v1.GetCartResponse.items:type_name -> cart.v1.CartItem
	1, // 1: cart.v1.CartService.GetCart:input_type -> cart.v1.GetCartRequest
	...
	7, // 4: cart.v1.CartService.ClearCart:input_type -> cart.v1.ClearCartRequest
	2, // 5: cart.v1.CartService.GetCart:output_type -> cart.v1.GetCartResponse
	4, // 6: cart.v1.CartService.AddItem:output_type -> cart.v1.AddItemResponse
	6, // 7: cart.v1.CartService.RemoveItem:output_type -> cart.v1.RemoveItemResponse
	8, // 8: cart.v1.CartService.ClearCart:output_type -> cart.v1.ClearCartResponse
